"""
    here we'll load the dsea_encoder and fit data to it.
"""
...
MODEL_NAME = '/home/nripesh/PycharmProjects/Siamese/canine_labeled/dsea_semi_sup_encoder.h5'
...
if os.path.isfile(src + 'patch_pairs_' + rand_idf + '_1.h5'):
    ...
    for i in range(no_of_files):
        ...
        x_0_encode = intensity_encoder.predict(x_data[:, 0, :])
        x_1_encode = intensity_encoder.predict(x_data[:, 1, :])
