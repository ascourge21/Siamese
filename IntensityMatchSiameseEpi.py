...
# train_name = 'x_data_intensity_epi_1_2'
# test_name = 'x_data_intensity_epi_3'
...
# train_name = 'x_data_intensity_epi_2_3'
# test_name = 'x_data_intensity_epi_1'
# x_train, y_train = createShapeData.get_int_paired_format(src, train_name)
# x_test, y_test = createShapeData.get_int_paired_format(src, test_name)
# model = train_model(x_train, y_train, 12)
...
train_name = 'x_data_intensity_epi_1_3'
test_name = 'x_data_intensity_epi_2'
x_train, y_train = createShapeData.get_int_paired_format(src, train_name)
x_test, y_test = createShapeData.get_int_paired_format(src, test_name)
model = train_model(x_train, y_train, 12)
...
train_name = 'x_data_intensity_epi_all'
x_train, y_train = createShapeData.get_int_paired_format(src, train_name)
x_test, y_test = createShapeData.get_int_paired_format(src, test_name)
model = train_model(x_train, y_train, 12)
print("epi trained on: all data")
# run_test(model, x_test, y_test, 2, 3, 1)
